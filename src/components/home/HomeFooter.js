    ...
    return (     
        <footer className="pa4 pa5-l black-70 bt b--black-10">
          <div className="mb4-l cf">
            <h1 className="fl w-100 pv0 f6 fw6 ttu tracked mb4">Farahy.</h1>
            <article className="fl w-50 dib-ns w-auto-ns mr4-m mr5-l mb4 pr2 pr0-ns">
              <h4 className="f5 f4-l fw6">Cairo</h4>
              <span className="f7 f6-l db black-70">183 Sameh Gado St.</span>
              <span className="f7 f6-l black-70">Cairo, Egypt </span>
